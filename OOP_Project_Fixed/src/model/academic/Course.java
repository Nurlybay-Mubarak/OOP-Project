...
public class Course implements Comparable<Course>, Serializable {
    ...
    private School        school;        // which school (faculty) owns this course
    ...
    /**
     * Returns the effective course type for a given student.
     * A MAJOR course from another school counts as ELECTIVE for the student.
     * Example: a SITE student taking a MAJOR course from SEG → it's an ELECTIVE for them.
     *
     * @param student the student to check
     * @return the effective CourseType for this student
     */
    public CourseType getEffectiveCourseType(Student student) {
        if (courseType == CourseType.MAJOR && student.getSchool() != this.school) {
